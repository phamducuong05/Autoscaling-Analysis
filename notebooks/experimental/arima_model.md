...
```
    ...
    Searching for optimal (p, q) parameters...
    Performing stepwise search to minimize aic
     ARIMA(0,0,0)(0,0,0)[0]             : AIC=210573.075, Time=0.07 sec
     ARIMA(1,0,0)(0,0,0)[0]             : AIC=166057.620, Time=0.08 sec
     ARIMA(0,0,1)(0,0,0)[0]             : AIC=195131.247, Time=0.56 sec
     ARIMA(2,0,0)(0,0,0)[0]             : AIC=164202.230, Time=0.11 sec
     ARIMA(3,0,0)(0,0,0)[0]             : AIC=inf, Time=0.24 sec
     ARIMA(2,0,1)(0,0,0)[0]             : AIC=162344.677, Time=0.88 sec
     ARIMA(1,0,1)(0,0,0)[0]             : AIC=162703.967, Time=0.88 sec
     ARIMA(3,0,1)(0,0,0)[0]             : AIC=162344.764, Time=2.24 sec
     ARIMA(2,0,2)(0,0,0)[0]             : AIC=162344.995, Time=2.67 sec
     ARIMA(1,0,2)(0,0,0)[0]             : AIC=162357.445, Time=0.79 sec
     ARIMA(3,0,2)(0,0,0)[0]             : AIC=162348.541, Time=1.19 sec
     ARIMA(2,0,1)(0,0,0)[0] intercept   : AIC=162311.394, Time=3.15 sec
     ARIMA(1,0,1)(0,0,0)[0] intercept   : AIC=162652.370, Time=1.95 sec
     ARIMA(2,0,0)(0,0,0)[0] intercept   : AIC=164006.371, Time=0.36 sec
     ARIMA(3,0,1)(0,0,0)[0] intercept   : AIC=162311.109, Time=7.10 sec
     ARIMA(3,0,0)(0,0,0)[0] intercept   : AIC=163236.377, Time=0.48 sec
     ARIMA(4,0,1)(0,0,0)[0] intercept   : AIC=162310.145, Time=8.13 sec
     ARIMA(4,0,0)(0,0,0)[0] intercept   : AIC=162786.068, Time=0.56 sec
     ARIMA(5,0,1)(0,0,0)[0] intercept   : AIC=162311.767, Time=10.26 sec
     ARIMA(4,0,2)(0,0,0)[0] intercept   : AIC=162314.795, Time=5.19 sec
     ARIMA(3,0,2)(0,0,0)[0] intercept   : AIC=162315.388, Time=4.53 sec
     ARIMA(5,0,0)(0,0,0)[0] intercept   : AIC=162587.614, Time=0.71 sec
     ARIMA(5,0,2)(0,0,0)[0] intercept   : AIC=162313.619, Time=11.08 sec
     ARIMA(4,0,1)(0,0,0)[0]             : AIC=162343.906, Time=3.11 sec
    
    Best model:  ARIMA(4,0,1)(0,0,0)[0] intercept
    Total fit time: 66.344 seconds
...
```
    ...
    ============================================================
    MANUAL PARAMETER SELECTION - MODEL FITTING
    ============================================================
    
    --- Manual Model A: ARIMA(1, 0, 0) ---
    AIC: 165668.50
    BIC: 165691.40
    Log Likelihood: -82831.25
    
    --- Manual Model B: ARIMA(2, 0, 0) ---
    AIC: 164006.37
    BIC: 164036.90
    Log Likelihood: -81999.18
...
```
    ...
    ============================================================
    AUTOMATIC PARAMETER SELECTION - RESULTS
    ============================================================
...
```
    ...
    ----------------------------------------------------------------------
    Manual A (ARIMA 1,0,0)    (1, 0, 0)       165668.50    165691.40    3358.35   
    Manual B (ARIMA 2,0,0)    (2, 0, 0)       164006.37    164036.90    1696.22   
    Auto (ARIMA 4,0,1)        (4, 0, 1)       162310.15    162310.15    0.00      
...
```
    ...
    ------------------------------------------------------------------------------
    const        192.2799      6.815     28.216      0.000     178.924     205.636
    ar.L1          0.9229      0.002    431.168      0.000       0.919       0.927
    sigma2      3026.5438     15.309    197.703      0.000    2996.540    3056.548
    ==============================================================================
    ...
    ==============================================================================
                     coef    std err          z      P>|z|      [0.025      0.975]
    ------------------------------------------------------------------------------
    const        192.2799      9.541     20.153      0.000     173.580     210.980
    ar.L1          0.6263      0.004    172.734      0.000       0.619       0.633
    ar.L2          0.3214      0.004     90.986      0.000       0.314       0.328
    sigma2      2714.0314     13.725    197.742      0.000    2687.131    2740.932
    ==============================================================================
    
    --- Auto Model: ARIMA(4, 0, 1) ---
    ==============================================================================
                     coef    std err          z      P>|z|      [0.025      0.975]
    ------------------------------------------------------------------------------
    intercept      1.0890      0.220      4.945      0.000       0.657       1.521
    ar.L1          1.2004      0.010    124.130      0.000       1.181       1.219
    ar.L2         -0.2290      0.008    -29.128      0.000      -0.244      -0.214
    ar.L3          0.0030      0.008      0.375      0.707      -0.013       0.018
    ar.L4          0.0200      0.007      3.026      0.002       0.007       0.033
    ma.L1         -0.7269      0.009    -82.579      0.000      -0.744      -0.710
    sigma2      2412.9325     11.689    206.430      0.000    2390.023    2435.842
    ==============================================================================
...
```
    ...
    Model                     RMSE         MAE          MAPE        
    ----------------------------------------------------------------------
    Manual A (1,0,0)          55.02        39.08        34.48       %
    Manual B (2,0,0)          52.10        36.51        35.70       %
    Auto (ARIMA)              49.27        33.97        37.53       %
...
```
    ...
    ----------------------------------------------------------------------
    Manual A (1,0,0)          0.000000        0.000000        2.5929         
    Manual B (2,0,0)          0.000000        0.000000        2.1426         
    Auto (ARIMA)              0.417709        0.000000        1.9998         
...
```
    ...
    ----------------------------------------------------------------------
    AIC                  165668.50       164006.37       162310.15      
    BIC                  165691.40       164036.90       162310.15      
    RMSE (In-Sample)     55.02           52.10           49.27          
    Ljung-Box OK         ✗               ✗               ✓              
    Parameters           1               2               5              
    ...
    Proceeding with ARIMA(4, 0, 1) for forecasting in Section 3
...
```
    ...
    ============================================================
    Model: ARIMA(4, 0, 1)
    Training data: 15264 observations
    Date range: 1995-07-01 00:00:00-04:00 to 1995-08-22 23:55:00-04:00
    ...
    ============================================================
                                   SARIMAX Results                                
    ==============================================================================
    Dep. Variable:               requests   No. Observations:                15264
    Model:                 ARIMA(4, 0, 1)   Log Likelihood              -81147.826
    Date:                Mon, 02 Feb 2026   AIC                         162309.652
    Time:                        18:59:14   BIC                         162363.085
    Sample:                    07-01-1995   HQIC                        162327.366
                             - 08-22-1995                                         
    Covariance Type:                  opg                                         
    ==============================================================================
                     coef    std err          z      P>|z|      [0.025      0.975]
    ------------------------------------------------------------------------------
    const        192.2801     22.309      8.619      0.000     148.556     236.005
    ar.L1          1.2036      0.010    124.358      0.000       1.185       1.223
    ar.L2         -0.2301      0.008    -29.164      0.000      -0.246      -0.215
    ar.L3          0.0015      0.008      0.194      0.846      -0.014       0.017
    ar.L4          0.0192      0.007      2.894      0.004       0.006       0.032
    ma.L1         -0.7301      0.009    -83.047      0.000      -0.747      -0.713
    sigma2      2427.3788     11.827    205.248      0.000    2404.199    2450.558
    ===================================================================================
    Ljung-Box (L1) (Q):                   0.00   Jarque-Bera (JB):             72197.03
    ...
    MODEL PARAMETERS
    ============================================================
    AR coefficients: [ 1.20363025 -0.23011002  0.00153822  0.01915161]
    MA coefficients: [-0.73013973]
...
```
    ...
    DIAGNOSTIC SUMMARY
    ============================================================
    The model is considered adequate if:
...
```
    ...
    ============================================================
    FORECAST SAMPLE (First 5 values)
    ============================================================
    1995-08-23 00:00:00-04:00    134.133352
    1995-08-23 00:05:00-04:00    133.467210
    1995-08-23 00:10:00-04:00    133.729079
    1995-08-23 00:15:00-04:00    134.210762
    1995-08-23 00:20:00-04:00    134.655195
    Freq: 5min
...
```
    ...
    INTERPRETATION
    ============================================================
    Ratio < 1.5: Good generalization (model not overfitting)
    Ratio 1.5-2.0: Moderate generalization (some overfitting)
    Ratio > 2.0: Poor generalization (significant overfitting)
...
![png](arima_model_files/arima_model_72_0.png)
...
![png](arima_model_files/arima_model_75_1.png)
...
```
    ...
    Model                RMSE         MAE          MAPE        
    ------------------------------------------------------------
    Naive (Last Value)   138.97       100.93       60.24       
    Mean Forecast        123.22       98.05        81.00       
    ARIMA({p},{d_optimal},{q}) 123.04       97.22        79.03       
    
    ============================================================
    IMPROVEMENT OVER BASELINES
    ============================================================
    vs Naive (Last Value):
      RMSE improvement: +11.5%
      MAE improvement: +3.7%
    
    vs Mean Forecast:
      RMSE improvement: +0.1%
      MAE improvement: +0.8%
    


    
![png](arima_model_files/arima_model_81_1.png)
